...
contract('SafeMathInt', () => {
  ...
  describe('add', function () {
    it('adds correctly', async function () {
      ...
      (await returnVal(safeMathInt.add(a, b))).should.be.bignumber.eq(a.add(b));
    });
  ...
  describe('sub', function () {
    it('subtracts correctly', async function () {
      ...
      (await returnVal(safeMathInt.sub(a, b))).should.be.bignumber.eq(a.sub(b));
    });
  ...
  describe('mul', function () {
    it('multiplies correctly', async function () {
      ...
      (await returnVal(safeMathInt.mul(a, b))).should.be.bignumber.eq(a.mul(b));
    });
  ...
  describe('abs', function () {
    it('works for 0', async function () {
      (await returnVal(safeMathInt.abs(0))).should.be.bignumber.eq( new BigNumber(0));
    });

    it('works on positive numbers', async function () {
      (await returnVal(safeMathInt.abs(100))).should.be.bignumber.eq(new BigNumber(100));
    });
